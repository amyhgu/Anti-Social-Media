    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        startCapturing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(), "Starting to record story", Toast.LENGTH_LONG).show();
                startRecordingVideo();
            }
        });
...
//        imageFile.saveInBackground();
        ...
        //get instance of current group

        //add the story to the group's story

        //save in background
    }

    public void playbackRecordedVideo() {
        VideoView mVideoView = (VideoView) mainView.findViewById(R.id.vv_story);
